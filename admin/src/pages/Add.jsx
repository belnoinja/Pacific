    ...
    <form onSubmit={onSubmitHandler} className="flex flex-col w-full items-start gap-3">
      ...
      <div className="flex flex-col sm:flex-row gap-2 w-full sm:gap-8">
        ...
        <div >
          ...
          <input onChange={(e)=>setPrice(e.target.value)} value={price} className="w-full px-3 py-2 sm:w-[120px]" type="Numeric" placeholder="25" />
        </div>
      ...
      <div className="flex gap-2 mt-2">
        ...
        <label className="cursor-pointer border px-3 py-2"   style={{ backgroundColor: bestSeller ? "pink" : "#f0f0f0" }} htmlFor="bestseller">Add to Bestseller</label>
      </div>

      <button type="submit" className="w-28 py-3 mt-4 bg-black text-white hover:text-black hover:bg-gray-300 ">ADD</button>
